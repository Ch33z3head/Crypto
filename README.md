...
hould be near .065 if plain: 0.0403014947475589
...
#Print the count of the most common letters in decesnding order
Counter({'s': 90, 'u': 55, 'c': 51, 'k': 44, 'p': 41, 'd': 38, 'j': 35, 'v': 31, 'b': 26, 'i': 23, 'l': 21, 'o': 20, 'w': 20, 'h': 19, 'y': 15, 'z': 15, 'q': 13, 'x': 12, 't': 9, 'a': 8, 'm': 6, 'e': 2, 'n': 1, 'r': 1})Prints most common bi grams in decending order from cipher
...
PS D:\School\Crypto\BACKUP\Mod 1> 
