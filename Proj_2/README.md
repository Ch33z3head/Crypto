...
### HowTo:
 1. This script (Encrypt_Decrytp_Image.py) will prompt you to enter one of three encytpion modes. -[Proj_2/Proj_2_Encrypt_Decrypt_Image_FINAL.py}(https://github.com/Ch33z3head/Crypto/blob/main/Proj_2/Proj_2_Encrypt_Decrypt_Image_FINAL.py))
