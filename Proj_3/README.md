# Project 3 Write up - Elliptic Curve Diffie-Hellman Exchange

### HowTo:

Simply execute the [Proj 3_EDHKE_FINAL.py](Proj_3/Proj_3_ECDH_FINAL.py) script and following the prompts.
